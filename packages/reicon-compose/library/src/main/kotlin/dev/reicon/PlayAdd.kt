    ...
    val Outline: ImageVector
        get() {
            ...
            _outline = ImageVector.Builder(
                ...
                addPath(
                    pathData = addPathNodes("M22 12C22 13.31 21.75 14.57 21.28 15.72C20.63 15.27 19.84 15 19 15C18.06 15 17.19 15.33 16.5 15.88C15.58 16.61 15 17.74 15 19C15 19.75 15.21 20.46 15.58 21.06C15.62 21.13 15.67 21.2 15.73 21.27C14.58 21.74 13.32 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z"),
                ...
                addPath(
                    pathData = addPathNodes("M9.38 12.0001V10.6101C9.38 8.89008 10.6 8.18007 12.09 9.04007L13.29 9.73007L14.49 10.4201C15.98 11.2801 15.98 12.6901 14.49 13.5501L13.29 14.2401L12.09 14.9301C10.6 15.7901 9.38 15.0901 9.38 13.3601V12.0001Z"),
                    pathFillType = PathFillType.NonZero,
                    fill = null,
                    stroke = SolidColor(Color.Black),
                    strokeLineWidth = 1.5f,
                ...
                addPath(
                    pathData = addPathNodes("M23 19C23 19.75 22.79 20.46 22.42 21.06C22.21 21.42 21.94 21.74 21.63 22C20.93 22.63 20.01 23 19 23C17.54 23 16.27 22.22 15.58 21.06C15.21 20.46 15 19.75 15 19C15 17.74 15.58 16.61 16.5 15.88C17.19 15.33 18.06 15 19 15C21.21 15 23 16.79 23 19Z"),
                    pathFillType = PathFillType.NonZero,
                    fill = null,
                    stroke = SolidColor(Color.Black),
                    strokeLineWidth = 1.5f,
                ...
                addPath(
                    pathData = addPathNodes("M20.49 18.98H17.51"),
                    pathFillType = PathFillType.NonZero,
                    fill = null,
                    stroke = SolidColor(Color.Black),
                    strokeLineWidth = 1.5f,
                ...
                addPath(
                    pathData = addPathNodes("M19 17.52V20.51"),
                    pathFillType = PathFillType.NonZero,
                    fill = null,
                    stroke = SolidColor(Color.Black),
                    strokeLineWidth = 1.5f,
