    ...
    val Filled: ImageVector
        get() {
            ...
            _filled = ImageVector.Builder(
                ...
                addPath(
                    pathData = addPathNodes("M20.1279 11.1429C20.1279 16.1924 16.0698 20.2859 11.0639 20.2859C6.05806 20.2859 2 16.1924 2 11.1429C2 6.09343 6.05806 2 11.0639 2C16.0698 2 20.1279 6.09343 20.1279 11.1429Z"),
                    pathFillType = PathFillType.NonZero,
                    fill = SolidColor(Color.Black),
                    stroke = null
                )
                addPath(
                    pathData = addPathNodes("M8.2944 11.1429C8.2944 10.7221 8.63257 10.381 9.04972 10.381H13.0781C13.4953 10.381 13.8335 10.7221 13.8335 11.1429C13.8335 11.5637 13.4953 11.9048 13.0781 11.9048H9.04972C8.63257 11.9048 8.2944 11.5637 8.2944 11.1429Z"),
                    pathFillType = PathFillType.EvenOdd,
                    fill = SolidColor(Color.Black),
                    stroke = null
                )
